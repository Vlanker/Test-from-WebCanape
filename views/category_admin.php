...
<img src="/icons/back.gif" alt="[PARENTDIR]"> <a href="/catalog-site.ru/admin/">Назад</a>
    ...
    <div>
        <form method="post" action="index.php?action=<?=$_GET['action']?>&id<?=$_GET['id']?>">
            ...
            <label>Активность категории<input type="checkbox" name="category_active" values="<?=$category['category_active']==1?'on':'NULL'?>" <?=$category['category_active']==1?'checked':''?>></label><br />
